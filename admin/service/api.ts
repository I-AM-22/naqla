...
import type {
  ...
  CarControllerFindMineForOrderPathParameters,
  ...
  SubOrdersControllerFindForOrderPathParameters,
...
export const carControllerFindMineForOrder = (
  { id }: CarControllerFindMineForOrderPathParameters,
  options?: SecondParameter<typeof fetchInstance>,
) => {
  return fetchInstance<Car[]>(
    { url: `/api/v1/drivers/cars/mine/order/${id}`, method: "GET" },
    options,
  );
};
...
export const subOrdersControllerFindForOrder = (
  { id }: SubOrdersControllerFindForOrderPathParameters,
  options?: SecondParameter<typeof fetchInstance>,
) => {
  return fetchInstance<SubOrder[]>(
    { url: `/api/v1/sub-orders/order/${id}`, method: "GET" },
    options,
  );
};
...
>;
export type CarControllerFindMineForOrderResult = NonNullable<
  Awaited<ReturnType<typeof carControllerFindMineForOrder>>
>;
...
>;
export type SubOrdersControllerFindForOrderResult = NonNullable<
  Awaited<ReturnType<typeof subOrdersControllerFindForOrder>>
>;
