...
export class ActiveAndOtp1709547596857 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "drivers" DROP COLUMN "passwordChangedAt"`);
        await queryRunner.query(`ALTER TABLE "drivers" DROP CONSTRAINT "UQ_f8e32d615cfd3bceecd6fec2331"`);
        await queryRunner.query(`ALTER TABLE "drivers" DROP COLUMN "passwordResetToken"`);
        await queryRunner.query(`ALTER TABLE "drivers" DROP COLUMN "passwordResetExpires"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "drivers" ADD "passwordResetExpires" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "drivers" ADD "passwordResetToken" character varying`);
        await queryRunner.query(`ALTER TABLE "drivers" ADD CONSTRAINT "UQ_f8e32d615cfd3bceecd6fec2331" UNIQUE ("passwordResetToken")`);
        await queryRunner.query(`ALTER TABLE "drivers" ADD "passwordChangedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "drivers" ADD "password" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "employees" ADD "storeId" character varying NOT NULL`);
    }
