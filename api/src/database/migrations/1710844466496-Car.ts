...
export class Car1710844466496 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cars_photos" ADD CONSTRAINT "FK_e849099cf387e9ac4e18485c03f" FOREIGN KEY ("carId") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cars" ADD CONSTRAINT "FK_d6b2e2318f189e47c39984bc3ff" FOREIGN KEY ("driverId") REFERENCES "drivers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cars" DROP CONSTRAINT "FK_d6b2e2318f189e47c39984bc3ff"`);
        await queryRunner.query(`ALTER TABLE "cars_photos" DROP CONSTRAINT "FK_e849099cf387e9ac4e18485c03f"`);
