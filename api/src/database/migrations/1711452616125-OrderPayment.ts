...
export class OrderPayment1711452616125 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "receiving_date"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "paymentId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "UQ_06a051324c76276ca2a9d1feb08" UNIQUE ("paymentId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "UQ_06a051324c76276ca2a9d1feb08"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "receiving_date" TIMESTAMP NOT NULL`);
