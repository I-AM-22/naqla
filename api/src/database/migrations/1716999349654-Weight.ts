...
export class Weight1716999349654 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sub_orders" DROP COLUMN "arrivalDate"`);
        await queryRunner.query(`ALTER TABLE "sub_orders" DROP COLUMN "deliveryDate"`);
        await queryRunner.query(`ALTER TABLE "sub_orders" ADD "weight" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sub_orders" ADD "deliveryDate" character varying`);
        await queryRunner.query(`ALTER TABLE "sub_orders" ADD "arrivalDate" character varying`);
    }
