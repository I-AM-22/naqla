...
abstract class $ResponseWrapperCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String? status, bool? success, String? message, T data});
}
...
class _$ResponseWrapperImpl<T> implements _ResponseWrapper<T> {
  const _$ResponseWrapperImpl(
      {this.status, this.success, this.message, required this.data});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, status, success, message,
