...
extension MyColorScheme on ColorScheme {
  ...
  Color get waiting => const Color(0xFFF9F871);

  Color get ready => const Color(0xFFFFBD6D);

  Color get delivered => const Color(0xFF54ECC4);

  Color get yellow => const Color(0xFFF5FD00);
