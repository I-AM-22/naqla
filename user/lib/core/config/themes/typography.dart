...
TextTheme textTheme = TextTheme(
  displayLarge: TextStyle(
      fontFamily: 'rubik', fontSize: 57.0.sp, fontWeight: FontWeight.w400),
  ...
  displaySmall: TextStyle(
      fontFamily: 'rubik', fontSize: 36.0.sp, fontWeight: FontWeight.w400),
  ...
  titleLarge: TextStyle(
      fontFamily: 'rubik', fontSize: 22.0.sp, fontWeight: FontWeight.w400),
  ...
  titleSmall: TextStyle(
      fontFamily: 'rubik', fontSize: 16.0.sp, fontWeight: FontWeight.w500),

  ///Label
  labelLarge: TextStyle(
      fontFamily: 'rubik', fontSize: 14.0.sp, fontWeight: FontWeight.w500),
  ...
  labelSmall: TextStyle(
      fontFamily: 'rubik', fontSize: 11.0.sp, fontWeight: FontWeight.w500),

  ///Body
  bodyLarge: TextStyle(
      fontFamily: 'rubik', fontSize: 16.0.sp, fontWeight: FontWeight.w400),
  ...
  bodySmall: TextStyle(
      fontFamily: 'rubik', fontSize: 12.0.sp, fontWeight: FontWeight.w400),
);
