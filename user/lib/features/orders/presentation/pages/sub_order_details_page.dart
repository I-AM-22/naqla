              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: data.status
                        .displayStatus(context, arrivedAt: data.arrivedAt),
                  ),
                  16.verticalSpace,
                  Padding(
                    padding: REdgeInsets.symmetric(
                      ...
                      child: RichText(
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                  text:
                                      '${S.of(context).cost}: ${data.cost} ${S.of(context).syp}\n'),
                              TextSpan(
                                  text:
                                      '${S.of(context).the_weight}: ${data.weight}\n'),
                  ...
                  Padding(
                    ...
                    child: AppText.subHeadMedium(
                        CoreHelperFunctions.formatOrderTime(
                            context, data.status,
